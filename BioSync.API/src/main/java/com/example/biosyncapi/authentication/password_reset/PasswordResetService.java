                                                        ...
                                                        <table width='100%' border='0' cellpadding='0' cellspacing='0'>
                                                            ...
                                                            <tr>
                                                                <td style='padding: 15px 0 0px;' align='center'>
                                                                    <img class='max-width' src='https://pupt.biosyncapp.site/assets/BioSyncLogo_WithoutText.png' alt='BioSync Logo' width='100'>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style='padding: 10px;' align='center'>
                                                                    ...
                                                                    <div style='text-align: center; margin-top: -1rem;'>
                                                                        <a href='%s' class='code-block'>Change Password</a>
                                                                    </div>
                                                                    <div class='link' style='text-align: center; margin-top: 1rem;'>
                                                                        <p>or copy and paste this link in your browser:</p>
                                                                        <p class='link-copy'>%s</p>
                                                                    </div>
                                                                    <div class='link' style='text-align: center; margin-top: 1rem;'>

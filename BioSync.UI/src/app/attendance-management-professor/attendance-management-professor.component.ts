...
@Component({
  selector: 'app-attendance-management-professor',
  standalone: true,
  imports: [MatToolbarModule, MatIconModule, CommonModule, FormsModule, MatSelectModule],
  templateUrl: './attendance-management-professor.component.html',
  styleUrl: './attendance-management-professor.component.css'
})
export class AttendanceManagementProfessorComponent {
  entries: string[] = [
    '10', '20', '30', '40', '50'
  ];
  ...
  student: subjectSchedule[] = [
    ...
    { subject_code: "COMP 2013", subject_name: "Computer Programming I", start_time: "01:00 PM", end_time: "05:00 PM", schedule_date: "MON, TUES", course: "DIT", year: "1", section: "1",  laboratory: "Aboitiz Laboratory", time_started: "01:00 PM", time_ended: "05:00 PM",},
  ];
  ...
  get filteredSubjectScheduleProfessor(): subjectSchedule[] {
